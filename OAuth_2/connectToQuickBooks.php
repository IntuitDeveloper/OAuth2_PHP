...
<?php
  ...
  if(isset($_SESSION['access_token']) && !empty($_SESSION['access_token'])){
    ...
    echo "<br /> <a class='imgLink' href='/connectToQuickBooks.php'><img style='height: 40px' src='IntuitSignIn-lg.jpg'/></a> <br />";
  }
    ...
    echo "<a class='imgLink' href='/signInWithIntuit.php'><img style='height: 40px' src='IntuitSignIn-lg.jpg'/></a>";
  //}
